...
public:
		...
		:m_block_size(0)
	{
		try
		{
			...
			std::cout << "input_file : " << m_input_file_path << std::endl;
			std::cout << "output_file : " << m_output_file_path << std::endl;
			std::cout << "block size : " << m_block_size << std::endl;
		}
		catch (const error &ex)
		{
			throw parser_exception( 1001, "parser", ex.what() );
		}
	...
	std::string& get_ouput_file_path()
	{
